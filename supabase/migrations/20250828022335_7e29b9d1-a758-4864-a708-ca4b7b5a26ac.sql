-- Temporarily remove foreign key constraints and reset data
-- First delete transaction items to avoid foreign key violations
...
WITH riders_to_delete AS (
  SELECT p.user_id, p.id as profile_id FROM profiles p
