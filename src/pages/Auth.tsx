      ...
      <div className="flex min-h-screen">
        ...
        <div className="flex-1 flex flex-col justify-center items-center px-8 lg:px-16 text-white">
          <div className="max-w-lg text-center space-y-8">
            ...
            {/* 3D Mockups */}
            <div className="flex justify-center items-end space-x-8 mt-12">
              <div className="transform hover:scale-105 transition-transform duration-300">
                <img 
                  src={iphoneMockup} 
                  alt="Zeger Coffee Mobile App" 
                  className="w-20 h-auto"
                />
              </div>
              <div className="transform hover:scale-105 transition-transform duration-300">
                <img 
                  src={motorcycleMockup} 
                  alt="Zeger Delivery Motorcycle" 
